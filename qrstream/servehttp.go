...
// Kept out of wasm builds: the live multipart stream is meaningless
// inside a browser, and excluding it keeps net/http (which TinyGo's
// js port cannot compile) out of the wasm decoder.
...
// motion stream (MJPEG-style, but with lossless PNG frames: sharp
// module edges, no JPEG ringing), which browsers render as a live
// video, until the client disconnects.
